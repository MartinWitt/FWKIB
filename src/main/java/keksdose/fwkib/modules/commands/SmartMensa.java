...
public class SmartMensa implements Command {
        ...
        public String apply(String message) {
                ...
                try {
                        ...
                        Iterator<Double> doubleStream = new SecureRandom().doubles(2, 6).distinct()
                                        .boxed().iterator();
                        mensa.append(date + " ");
                        mensa.append("Linie 1: " + foodStream.next() + " "
                                        + df.format(doubleStream.next()) + "0 " + "\u20ac, "
                                        + foodStream.next() + " " + df.format(doubleStream.next())
                                        + "0 " + "\u20ac ");
                        mensa.append("Linie 2: " + foodStream.next() + " "
                                        + df.format(doubleStream.next()) + "0 " + "\u20ac, "
                                        + foodStream.next() + " " + df.format(doubleStream.next())
                                        + "0 " + "\u20ac ");
                        mensa.append("Linie 3: " + foodStream.next() + " "
                                        + df.format(doubleStream.next()) + "0 " + "\u20ac, "
                                        + foodStream.next() + " " + df.format(doubleStream.next())
                                        + "0 " + "\u20ac ");
                        mensa.append("Linie 4/5: " + foodStream.next() + " "
                                        + df.format(doubleStream.next()) + "0 " + "\u20ac, "
                                        + foodStream.next() + " " + df.format(doubleStream.next())
                                        + "0 " + "\u20ac ");
